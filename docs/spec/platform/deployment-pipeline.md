...
| Event Ingest Worker      | Four datasource-specific Queue producer/consumer bindings, four matching DLQ producer bindings, one SQLite Admission Gate Durable Object class binding, sharded ingest/outbox/recovery Durable Objects, scoped Tinybird write and reconciliation-read secrets |
