...
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| `RUN_FROZEN`            | Attempt to mutate a frozen **assignment** field on a running Run (App-level and Flag-Configuration fields also return `RUN_FROZEN`, with `END_RUNNING_RUN_FIRST`) | `CREATE_NEW_RUN`        |
