...
| `EXPERIMENT_KEY_CONFLICT`         | `CHOOSE_DIFFERENT_KEY`    | an archived Experiment still holds `(app, env, key)`; resend create with a different key (keys are not freed on archive)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
