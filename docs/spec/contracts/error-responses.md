...
- `EVENT_SCHEMA_MISMATCH` — unknown, missing, type-invalid, allowlist-invalid, or range-invalid
  ...
  paths; they omit Event Definition Version IDs, configured bounds, allowed values, and Entity types.
