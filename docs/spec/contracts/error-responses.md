...
ErrorCode =
  ...
  | 'FLAG_SELECTOR_AMBIGUOUS'    // flags_get selector matched one Flag by id and a different Flag by key
...
| `FLAG_SELECTOR_AMBIGUOUS`          | `{ selector: string, idMatchFlagId: string, keyMatchFlagId: string, recommendedAction: 'PASS_CANONICAL_FLAG_ID' }`                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
RecommendedAction =
  ...
  | 'PASS_CANONICAL_FLAG_ID' // flags_get selector matched two Flags; retry with the intended Flag's canonical id
...
| `FLAG_SELECTOR_AMBIGUOUS`         | `PASS_CANONICAL_FLAG_ID`  | the `flags_get` path param matched one Flag by id and a different Flag by key; retry with the intended Flag's canonical id (`details.idMatchFlagId` / `details.keyMatchFlagId`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
