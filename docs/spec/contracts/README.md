...
| [storage-schemas-d1-experiment.md](./storage-schemas-d1-experiment.md)                                   | D1 experiment-side tables: experiments, Runs, immutable conclusions, Approval Request links, typed-field Metrics, credentials      |
| [storage-schemas-d1-integrations.md](./storage-schemas-d1-integrations.md)                               | D1 Convex installation, encrypted webhook secret, and durable config-delivery outbox tables                                        |
