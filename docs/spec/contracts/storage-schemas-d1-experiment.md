...
| `data_watermark`              | timestamptz | not null; inclusive `ingest_ts` boundary                            |
...
| `rate_limit_rps`   | integer     | nullable; new writes are an exact enforceable rps (`1, 2, 3, 4, 5, 6, 10, 12, 15, 20, 25, 30, 50, 60, 75, 100`) or null (100 rps default). Legacy integers may still be present.                                                           |
