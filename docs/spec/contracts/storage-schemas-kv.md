...
rollout, marks it unscoped, and fails closed for billing-bearing evaluation until
the control plane rewrites the cache entry from its D1 Organization authority.
