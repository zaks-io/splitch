...
| [exposure-firing-and-accessor.md](./exposure-firing-and-accessor.md) | `evaluate()` vs `peek()` SDK accessor contract; Exposure event shape; first-touch identity + wire dedup_key; holdover short-circuit |
