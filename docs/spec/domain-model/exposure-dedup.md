...
| Pipeline dedup | `GROUP BY (app_id, environment_id, experiment_id, run_id, id_type, targeting_key_hash)` + `MIN(exposure_at)` | Correctness authority                |
