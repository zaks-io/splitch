...
const expectedVerifyCi =
  "pnpm audit --audit-level=high && turbo run //#depcruise //#knip //#format:check //#spec:lint //#docs:lint //#check:cli-mcp-parity //#test:scripts lint typecheck test test:connect-snippet stats:golden stats:property build";
