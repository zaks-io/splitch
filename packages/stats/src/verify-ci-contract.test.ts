...
const expectedVerifyCi =
  "pnpm format:check && pnpm lint && pnpm typecheck && pnpm knip && pnpm spec:lint && pnpm check:cli-mcp-parity && pnpm test:scripts && pnpm test && pnpm smoke:connect-snippet && pnpm stats:golden && pnpm stats:property && pnpm build";
