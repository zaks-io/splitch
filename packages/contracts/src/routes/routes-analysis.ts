...
import {
  ...
  EntityStorePrivacyExportRequestSchema,
...
export const analysisRoutes = [
  defineApiRoute({
    ...
    summary:
      "Dry-run resolve a Flag with the flat data-plane reason token and full resolution detail without firing an Exposure.",
  ...
  defineApiRoute({
    ...
    request: { params: AppParams, body: EntityStorePrivacyExportRequestSchema },
