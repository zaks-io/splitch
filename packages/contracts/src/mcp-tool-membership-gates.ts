...
const MCP_TOOL_MEMBERSHIP_GATES = {
  ...
  convex_panel_installations_list: APP_ADMIN,
  convex_panel_installations_delete: APP_ADMIN,
  cloudflare_panel_installations_list: APP_ADMIN,
  cloudflare_panel_installations_delete: APP_ADMIN,
