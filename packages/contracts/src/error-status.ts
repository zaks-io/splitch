...
export const errorStatusByCode: Record<ErrorCode, number> = {
  ...
  CONVEX_INSTALLATION_NOT_FOUND: 404,
  CLOUDFLARE_INSTALLATION_NOT_FOUND: 404,
  SENTRY_INSTALLATION_NOT_FOUND: 404,
