...
const EXPECTED_GATES: Record<string, string> = {
  ...
  app_members_list: "app:member",
  app_members_add: "app:admin",
  app_members_update: "app:owner",
  app_members_remove: "app:owner",
  ...
  sentry_installations_list: "app:admin",
  sentry_installations_create: "app:admin",
  sentry_installations_get: "app:admin",
  sentry_installations_delete: "app:admin",
  sentry_secret_rotations_create: "app:admin",
  convex_panel_installations_list: "app:admin",
  convex_panel_installations_delete: "app:admin",
  cloudflare_panel_installations_list: "app:admin",
  cloudflare_panel_installations_delete: "app:admin",
