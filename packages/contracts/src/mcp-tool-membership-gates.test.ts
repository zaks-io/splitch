...
const EXPECTED_GATES: Record<string, string> = {
  ...
  convex_installations_list: "app:admin",
  convex_installations_revoke: "app:admin",
  cloudflare_installations_list: "app:admin",
  cloudflare_installations_revoke: "app:admin",
