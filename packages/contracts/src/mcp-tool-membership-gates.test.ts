...
const EXPECTED_GATES: Record<string, string> = {
  ...
  sentry_installations_list: "org:admin",
  sentry_installations_create: "org:admin",
  sentry_installations_get: "org:admin",
  sentry_installations_delete: "org:admin",
  sentry_secret_rotations_create: "org:admin",
