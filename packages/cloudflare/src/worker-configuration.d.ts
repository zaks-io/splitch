/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: e77e61c1d61176d92df595b62fef54d2)
// Runtime types generated with workerd@1.20260722.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	SPLITCH_INSTALLATION_ID: "00000000-0000-4000-8000-000000000000";
	SPLITCH_ENDPOINT: "https://edge.splitch.dev";
	SPLITCH_STATE: DurableObjectNamespace<import("./worker").SplitchState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "SplitchState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPLITCH_INSTALLATION_ID" | "SPLITCH_ENDPOINT">> {}
}
