/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 85c1c6e1cb175088032b6de02a57bb8a)
// Runtime types generated with workerd@1.20260826.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	...
	SPLITCH_PLATFORM_TARGET: "shared-preview" | "production" | "local";
	AUTH_JWKS_URI?: "https://auth.preview.splitch.dev/.well-known/jwks.json" | "https://auth.splitch.dev/.well-known/jwks.json";
	CONTROL_PLANE_ORIGIN?: "https://api.preview.splitch.dev" | "https://api.splitch.dev";
	SENTRY_DSN: string;
	EVALUATION_PRIVACY_SALT?: string;
	EXPOSURE_TICKET_KEY?: string;
	SPLITCH_EVENT_INGEST_TOKEN: string;
	CONFIG_STORE_WRITER: DurableObjectNamespace /* ConfigStoreDurableObject from splitch-control-plane-api-shared-preview */ | DurableObjectNamespace /* ConfigStoreDurableObject from splitch-control-plane-api */;
	ASSIGNMENT_STORE_WRITER: DurableObjectNamespace<import("./index").AssignmentStoreDurableObjectV2>;
	MCP_DELEGATION_REPLAY: DurableObjectNamespace<import("./index").McpDelegationReplayDurableObject>;
	EXPOSURE_REDEMPTION_CLAIMS: DurableObjectNamespace<import("./index").ExposureRedemptionClaimDurableObject>;
	HOLDOVER_WRITE_OUTBOX: DurableObjectNamespace<import("./index").HoldoverWriteOutboxDurableObject>;
	HOLDOVER_WRITE_APP_INVENTORY: DurableObjectNamespace<import("./index").HoldoverWriteAppInventoryDurableObject>;
	EVENT_INGEST: Service /* entrypoint EvaluationEntrypoint from splitch-event-ingest-api-shared-preview */ | Service /* entrypoint EvaluationEntrypoint from splitch-event-ingest-api */;
	CONTROL_PLANE_API: Service /* entrypoint EvaluationEntrypoint from splitch-control-plane-api-shared-preview */ | Service /* entrypoint EvaluationEntrypoint from splitch-control-plane-api */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "McpDelegationReplayDurableObject" | "ExposureRedemptionClaimDurableObject" | "HoldoverWriteOutboxDurableObject" | "HoldoverWriteAppInventoryDurableObject" | "AssignmentStoreDurableObjectV2";
	}
	interface SharedPreviewEnv {
		ASSIGNMENTS_KV: KVNamespace;
		CONFIG_STORE: KVNamespace;
		CREDENTIAL_STORE: KVNamespace;
		SESSION_STORE: KVNamespace;
		...
		EXPOSURE_TICKET_KEY: string;
		SPLITCH_EVENT_INGEST_TOKEN: string;
		CONFIG_STORE_WRITER: DurableObjectNamespace /* ConfigStoreDurableObject from splitch-control-plane-api-shared-preview */;
		ASSIGNMENT_STORE_WRITER: DurableObjectNamespace<import("./index").AssignmentStoreDurableObjectV2>;
		MCP_DELEGATION_REPLAY: DurableObjectNamespace<import("./index").McpDelegationReplayDurableObject>;
		EXPOSURE_REDEMPTION_CLAIMS: DurableObjectNamespace<import("./index").ExposureRedemptionClaimDurableObject>;
		HOLDOVER_WRITE_OUTBOX: DurableObjectNamespace<import("./index").HoldoverWriteOutboxDurableObject>;
		HOLDOVER_WRITE_APP_INVENTORY: DurableObjectNamespace<import("./index").HoldoverWriteAppInventoryDurableObject>;
		EVENT_INGEST: Service /* entrypoint EvaluationEntrypoint from splitch-event-ingest-api-shared-preview */;
		CONTROL_PLANE_API: Service /* entrypoint EvaluationEntrypoint from splitch-control-plane-api-shared-preview */;
	}
	interface ProductionEnv {
		...
		EXPOSURE_TICKET_KEY: string;
		SPLITCH_EVENT_INGEST_TOKEN: string;
		CONFIG_STORE_WRITER: DurableObjectNamespace /* ConfigStoreDurableObject from splitch-control-plane-api */;
		ASSIGNMENT_STORE_WRITER: DurableObjectNamespace<import("./index").AssignmentStoreDurableObjectV2>;
		MCP_DELEGATION_REPLAY: DurableObjectNamespace<import("./index").McpDelegationReplayDurableObject>;
		EXPOSURE_REDEMPTION_CLAIMS: DurableObjectNamespace<import("./index").ExposureRedemptionClaimDurableObject>;
		HOLDOVER_WRITE_OUTBOX: DurableObjectNamespace<import("./index").HoldoverWriteOutboxDurableObject>;
		HOLDOVER_WRITE_APP_INVENTORY: DurableObjectNamespace<import("./index").HoldoverWriteAppInventoryDurableObject>;
		EVENT_INGEST: Service /* entrypoint EvaluationEntrypoint from splitch-event-ingest-api */;
		CONTROL_PLANE_API: Service /* entrypoint EvaluationEntrypoint from splitch-control-plane-api */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPLITCH_PLATFORM_TARGET" | "AUTH_JWKS_URI" | "CONTROL_PLANE_ORIGIN" | "SENTRY_DSN" | "EVALUATION_PRIVACY_SALT" | "EXPOSURE_TICKET_KEY" | "SPLITCH_EVENT_INGEST_TOKEN">> {}
}
