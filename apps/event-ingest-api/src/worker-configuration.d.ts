/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 2af55c484a17ddd3c31ca005af925fce)
...
interface __BaseEnv_Env {
	...
	RAW_EVENTS_DLQ: Queue;
	RAW_EVALUATIONS_QUEUE: Queue;
	RAW_EVALUATIONS_DLQ: Queue;
	METRIC_EVENTS_QUEUE: Queue;
	METRIC_EVENTS_DLQ: Queue;
	METRIC_EVENTS_RECONCILIATION_QUEUE: Queue;
	METRIC_EVENTS_RECONCILIATION_DLQ: Queue;
	...
	ASSIGNMENT_STORE_WRITER: DurableObjectNamespace /* AssignmentStoreDurableObjectV2 from splitch-evaluation-api-shared-preview */ | DurableObjectNamespace /* AssignmentStoreDurableObjectV2 from splitch-evaluation-api */;
	EVALUATION_USAGE_REPLAY_WINDOW: DurableObjectNamespace<import("./index").EvaluationUsageReplayWindowDurableObject>;
	EVALUATION_COMMIT_OUTBOX: DurableObjectNamespace<import("./index").EvaluationCommitOutboxDurableObject>;
	METRIC_EVENT_OUTBOX: DurableObjectNamespace<import("./index").MetricEventOutboxDurableObject>;
	METRIC_EVENT_CLAIM_RETENTION_BACKFILL: DurableObjectNamespace<import("./index").MetricEventClaimRetentionBackfillDurableObject>;
	METRIC_EVENT_RATE_LIMIT: DurableObjectNamespace<import("./index").MetricEventRateLimitDurableObject>;
	INGEST_ADMISSION_GATE: DurableObjectNamespace<import("./index").IngestAdmissionGateDurableObject>;
	ENTITY_METRIC_PRIVACY: DurableObjectNamespace<import("./index").EntityMetricPrivacyDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "EvaluationUsageReplayWindowDurableObject" | "EvaluationCommitOutboxDurableObject" | "MetricEventOutboxDurableObject" | "MetricEventRateLimitDurableObject" | "IngestAdmissionGateDurableObject" | "EntityMetricPrivacyDurableObject" | "MetricEventClaimRetentionBackfillDurableObject";
	}
	interface SharedPreviewEnv {
		...
		ASSIGNMENT_STORE_WRITER: DurableObjectNamespace /* AssignmentStoreDurableObjectV2 from splitch-evaluation-api-shared-preview */;
		EVALUATION_USAGE_REPLAY_WINDOW: DurableObjectNamespace<import("./index").EvaluationUsageReplayWindowDurableObject>;
		EVALUATION_COMMIT_OUTBOX: DurableObjectNamespace<import("./index").EvaluationCommitOutboxDurableObject>;
		METRIC_EVENT_OUTBOX: DurableObjectNamespace<import("./index").MetricEventOutboxDurableObject>;
		METRIC_EVENT_CLAIM_RETENTION_BACKFILL: DurableObjectNamespace<import("./index").MetricEventClaimRetentionBackfillDurableObject>;
	...
	interface ProductionEnv {
		...
		ASSIGNMENT_STORE_WRITER: DurableObjectNamespace /* AssignmentStoreDurableObjectV2 from splitch-evaluation-api */;
		EVALUATION_USAGE_REPLAY_WINDOW: DurableObjectNamespace<import("./index").EvaluationUsageReplayWindowDurableObject>;
		EVALUATION_COMMIT_OUTBOX: DurableObjectNamespace<import("./index").EvaluationCommitOutboxDurableObject>;
		METRIC_EVENT_OUTBOX: DurableObjectNamespace<import("./index").MetricEventOutboxDurableObject>;
		METRIC_EVENT_CLAIM_RETENTION_BACKFILL: DurableObjectNamespace<import("./index").MetricEventClaimRetentionBackfillDurableObject>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPLITCH_PLATFORM_TARGET" | "SPLITCH_SOURCE_ID" | "TINYBIRD_API_URL" | "SENTRY_DSN" | "SPLITCH_EVENT_INGEST_TOKEN" | "TINYBIRD_INGEST_TOKEN" | "TINYBIRD_READ_TOKEN" | "TINYBIRD_COPY_TOKEN" | "EVALUATION_PRIVACY_SALT">> {}
}
