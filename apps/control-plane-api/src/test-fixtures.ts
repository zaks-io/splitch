...
const SCHEMA = [
  ...
  `CREATE TABLE metrics (id TEXT PRIMARY KEY NOT NULL, app_id TEXT NOT NULL, key TEXT NOT NULL, name TEXT NOT NULL, description TEXT, kind TEXT NOT NULL, event_name TEXT NOT NULL, event_value_field TEXT, denominator_metric_id TEXT, downside_threshold_pct REAL, winsorize INTEGER, winsorize_pct REAL, cuped INTEGER, cuped_coverage_threshold_pct REAL, created_at TEXT NOT NULL, created_by TEXT)`,
  ...
  `CREATE TABLE approval_request_archive_checkpoints (approval_request_id TEXT NOT NULL, app_id TEXT NOT NULL, archive_version INTEGER NOT NULL, content_checksum TEXT NOT NULL, row_count INTEGER NOT NULL, proposed_at TEXT NOT NULL, resolved_at TEXT NOT NULL, archived_at TEXT NOT NULL, PRIMARY KEY (approval_request_id, archive_version))`,
