...
const SCHEMA = [
  ...
  `CREATE TABLE privacy_requests (request_id TEXT PRIMARY KEY NOT NULL, org_id TEXT NOT NULL, app_id TEXT, request_type TEXT NOT NULL, subject_type TEXT NOT NULL, subject_ref TEXT NOT NULL, requested_by TEXT NOT NULL, status TEXT NOT NULL, received_at TEXT NOT NULL, ack_due_at TEXT NOT NULL, response_due_at TEXT NOT NULL, completed_at TEXT, denial_reason TEXT, result_json TEXT)`,
