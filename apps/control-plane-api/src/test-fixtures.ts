...
const SCHEMA = [
  ...
  `CREATE TABLE approval_requests (id TEXT PRIMARY KEY NOT NULL, app_id TEXT NOT NULL, operation TEXT NOT NULL, target_type TEXT NOT NULL, target_id TEXT NOT NULL, target_version TEXT NOT NULL, policy_contexts TEXT NOT NULL, policy_guard_contexts TEXT, diff TEXT NOT NULL, status TEXT NOT NULL, proposed_by TEXT NOT NULL, proposed_via TEXT NOT NULL, proposed_at TEXT NOT NULL, resolved_at TEXT, resulting_target_version TEXT, resulting_resource_type TEXT, resulting_resource_id TEXT, idempotency_key TEXT NOT NULL, request_hash TEXT NOT NULL)`,
  `CREATE UNIQUE INDEX approval_requests_actor_idempotency_unique ON approval_requests (app_id, proposed_by, idempotency_key)`,
  `CREATE TABLE experiment_conclusions (id TEXT PRIMARY KEY NOT NULL, app_id TEXT NOT NULL, environment_id TEXT NOT NULL, experiment_id TEXT NOT NULL, run_id TEXT NOT NULL, selected_variant TEXT NOT NULL, config_hash TEXT NOT NULL, result_token TEXT NOT NULL, data_watermark TEXT NOT NULL, result_snapshot TEXT NOT NULL, decision_failures TEXT NOT NULL, decision_checks TEXT NOT NULL, target_environment_id TEXT NOT NULL, target_flag_id TEXT NOT NULL, target_config_version INTEGER NOT NULL, proposed_flag_configuration TEXT NOT NULL, reason TEXT, concluded_by TEXT NOT NULL, concluded_via TEXT NOT NULL, concluded_at TEXT NOT NULL, idempotency_key TEXT NOT NULL, request_hash TEXT NOT NULL)`,
  ...
  `CREATE TABLE conclusion_approval_requests (app_id TEXT NOT NULL, conclusion_id TEXT NOT NULL, approval_request_id TEXT NOT NULL, ordinal INTEGER NOT NULL, created_at TEXT NOT NULL, PRIMARY KEY (conclusion_id, ordinal))`,
  ...
  `CREATE TABLE privacy_requests (request_id TEXT PRIMARY KEY NOT NULL, org_id TEXT NOT NULL, app_id TEXT, request_type TEXT NOT NULL, subject_type TEXT NOT NULL, subject_ref TEXT NOT NULL, subject_ref_redacted_at TEXT, requested_by TEXT NOT NULL, status TEXT NOT NULL, received_at TEXT NOT NULL, ack_due_at TEXT NOT NULL, response_due_at TEXT NOT NULL, completed_at TEXT, denial_reason TEXT, result_json TEXT, idempotency_key TEXT, request_hash TEXT)`,
  `CREATE UNIQUE INDEX privacy_requests_entity_idempotency_unique ON privacy_requests (app_id, requested_by, request_type, idempotency_key)`,
  `CREATE TABLE privacy_jobs (job_id TEXT PRIMARY KEY NOT NULL, request_id TEXT NOT NULL UNIQUE, kind TEXT NOT NULL, status TEXT NOT NULL, store_status_json TEXT NOT NULL, delete_before_ts TEXT, identity_version TEXT NOT NULL, id_type TEXT, entity_family_hash TEXT, lease_expires_at TEXT, artifact_key TEXT, artifact_sha256 TEXT, artifact_expires_at TEXT, error_code TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL)`,
