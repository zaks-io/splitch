...
const SCHEMA = [
  ...
  `CREATE TABLE privacy_jobs (job_id TEXT PRIMARY KEY NOT NULL, request_id TEXT NOT NULL UNIQUE, kind TEXT NOT NULL, status TEXT NOT NULL, store_status_json TEXT NOT NULL, delete_before_ts TEXT, identity_version TEXT NOT NULL, lease_expires_at TEXT, artifact_key TEXT, artifact_sha256 TEXT, artifact_expires_at TEXT, error_code TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL)`,
