...
const SCHEMA = [
  ...
  `CREATE TABLE targeting_rules (id TEXT PRIMARY KEY NOT NULL, app_id TEXT NOT NULL, environment_id TEXT NOT NULL, flag_id TEXT NOT NULL, priority INTEGER NOT NULL, conditions TEXT NOT NULL, segment_id TEXT, variant_id TEXT, percentage_rollout TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL, FOREIGN KEY (app_id, segment_id) REFERENCES segments(app_id, id) ON DELETE RESTRICT)`,
