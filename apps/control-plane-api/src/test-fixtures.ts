...
const SCHEMA = [
  ...
  `CREATE TABLE runs (id TEXT PRIMARY KEY NOT NULL, app_id TEXT NOT NULL, environment_id TEXT NOT NULL, experiment_id TEXT NOT NULL, run_number INTEGER NOT NULL, status TEXT DEFAULT 'running' NOT NULL, targeting_key_field TEXT NOT NULL, targeting_key_type TEXT NOT NULL, salt TEXT NOT NULL, allocation TEXT NOT NULL, variant_set TEXT NOT NULL, control_variant_id TEXT NOT NULL, targeting_rules TEXT NOT NULL, activation_metric_id TEXT, confidence_level REAL NOT NULL, horizon TEXT DEFAULT 'sequential' NOT NULL, target_n INTEGER, sample_size_locked INTEGER, decision_family TEXT NOT NULL, guardrail_decisions TEXT NOT NULL, config_hash TEXT NOT NULL, started_at TEXT NOT NULL, ended_at TEXT, start_reason TEXT, end_reason TEXT, created_at TEXT NOT NULL, created_by TEXT)`,
