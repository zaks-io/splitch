...
const SCHEMA = [
  ...
  `CREATE TABLE event_definitions (id TEXT PRIMARY KEY NOT NULL, app_id TEXT NOT NULL, name TEXT NOT NULL, family TEXT NOT NULL, display_name TEXT NOT NULL, description TEXT, current_published_version_id TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL, created_by TEXT, updated_by TEXT)`,
  ...
  `CREATE TABLE metrics (id TEXT PRIMARY KEY NOT NULL, app_id TEXT NOT NULL, key TEXT NOT NULL, name TEXT NOT NULL, description TEXT, kind TEXT NOT NULL, event_definition_id TEXT, event_field_name TEXT, denominator_metric_id TEXT, downside_threshold_pct REAL, winsorize INTEGER, winsorize_pct REAL, cuped INTEGER, cuped_coverage_threshold_pct REAL, created_at TEXT NOT NULL, created_by TEXT)`,
