...
export interface AuthApiEnv {
   ...
   * targets and must not be any committed local/test fixture secret. local/pr-ci
   * may use the committed fixture. DELIBERATELY distinct from ACCESS_TOKEN_SECRET
   * so an assertion can never verify as a Bearer.
   */
