...
const SCHEMA = [
  ...
  `CREATE TABLE organizations (id TEXT PRIMARY KEY NOT NULL, name TEXT NOT NULL, plan TEXT DEFAULT 'free' NOT NULL, stripe_customer_id TEXT, stripe_subscription_id TEXT, sso_enabled INTEGER DEFAULT 0 NOT NULL, is_provisional INTEGER DEFAULT 0 NOT NULL, demo_expires_at TEXT, claim_acquired_at TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL)`,
  ...
  `CREATE TABLE claim_idempotency (key_hash TEXT PRIMARY KEY NOT NULL, verification_id TEXT NOT NULL, provisional_user_hash TEXT NOT NULL, email_hash TEXT NOT NULL, completed_at TEXT NOT NULL, expires_at TEXT NOT NULL)`,
];
