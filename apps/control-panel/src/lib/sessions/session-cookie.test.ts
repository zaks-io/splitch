...
const FORM_POST_SURFACE = createFormPostSurfaceDiscovery(SOURCE_PROGRAM, {
  originGuard: {
    ...
    filePath: join(SRC, "lib/auth/panel-csrf.ts"),
  },
  sessionCookieAccessor: {
    exportName: "loadSessionFromCookieHeader",
    filePath: join(SRC, "lib/sessions/session.ts"),
  },
});
...
const CREATE_SERVER_FN_POST_WRITES = [
  "lib/claims/claim-ceremony-functions.ts#submitClaimCeremony",
  "lib/apps/control-plane-app-functions.ts#createControlPanelApp",
  "lib/apps/control-plane-app-settings-functions.ts#addControlPanelAppMember",
  "lib/apps/control-plane-app-settings-functions.ts#deleteControlPanelApp",
  "lib/apps/control-plane-app-settings-functions.ts#removeControlPanelAppMember",
  "lib/apps/control-plane-app-settings-functions.ts#updateControlPanelApp",
  ...
  "lib/flags/control-plane-flag-functions.ts#createControlPanelFlag",
  "lib/flags/control-plane-flag-mutations.ts#editControlPanelTargetingRules",
  "lib/flags/control-plane-flag-mutations.ts#loadControlPanelApprovalRequest",
  "lib/flags/control-plane-flag-mutations.ts#promoteControlPanelFlagConfig",
  "lib/flags/control-plane-flag-mutations.ts#reviewControlPanelApprovalRequest",
  "lib/flags/control-plane-flag-mutations.ts#updateControlPanelFlagConfig",
  "lib/metrics/control-plane-metric-functions.ts#deleteControlPanelMetric",
  "lib/metrics/control-plane-metric-functions.ts#saveControlPanelMetric",
  "lib/organizations/control-plane-org-member-functions.ts#addControlPanelOrgMember",
  "lib/organizations/control-plane-org-member-functions.ts#removeControlPanelOrgMember",
  "lib/organizations/control-plane-org-member-functions.ts#updateControlPanelOrgMemberRole",
  "lib/organizations/control-plane-organization-functions.ts#createControlPanelOrganization",
  "lib/segments/control-plane-segment-functions.ts#deleteControlPanelSegment",
  "lib/segments/control-plane-segment-functions.ts#saveControlPanelSegment",
  "lib/integrations/control-plane-sentry-functions.ts#installControlPanelSentry",
  "lib/integrations/control-plane-sentry-functions.ts#revokeControlPanelSentryInstallation",
  "lib/integrations/control-plane-sentry-functions.ts#rotateControlPanelSentrySecret",
  "lib/settings/control-plane-settings-functions.ts#lockControlPanelClientKey",
  "lib/settings/control-plane-settings-functions.ts#provisionControlPanelApiKey",
  "lib/settings/control-plane-settings-functions.ts#revokeControlPanelApiKey",
  "lib/settings/control-plane-settings-functions.ts#updateControlPanelEnvironmentPolicy",
  "lib/connect/control-plane-verify-functions.ts#verifyControlPanelFlag",
] as const;
...
function cookieConstructionOffenders(path: string): Array<string> {
  ...
  if (relativePath === "lib/sessions/session-cookie.ts") return [];
...
function cookieHeaderWrites(path: string): Array<string> {
  ...
  return COOKIE_HEADER_WRITES.setCookieHeaderWrites(path, relativePath, {
    allowSerializedCookieAssertion: relativePath === "lib/sessions/session-cookie.ts",
