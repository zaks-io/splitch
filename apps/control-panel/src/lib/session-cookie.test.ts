...
const CREATE_SERVER_FN_POST_WRITES = [
  ...
  "lib/control-plane-sentry-functions.ts#installControlPanelSentry",
  "lib/control-plane-sentry-functions.ts#revokeControlPanelSentryInstallation",
  "lib/control-plane-sentry-functions.ts#rotateControlPanelSentrySecret",
