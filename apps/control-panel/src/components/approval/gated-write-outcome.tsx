import type { GatedWritePhase } from "#lib/approval/gated-write-phase";
import { ApprovalGateDialog } from "#components/approval/approval-gate-dialog";
import { ApprovalRecordNote } from "#components/approval/approval-record-note";
import { ApprovalRefusalNotice } from "#components/approval/approval-refusal-notice";
