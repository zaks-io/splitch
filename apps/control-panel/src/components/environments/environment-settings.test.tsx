...
vi.mock("#lib/integrations/control-plane-convex-functions", () => ({
  loadControlPanelConvexInstallations: vi.fn(),
  revokeControlPanelConvexInstallation: vi.fn(),
}));

vi.mock("#lib/integrations/control-plane-cloudflare-functions", () => ({
  loadControlPanelCloudflareInstallations: vi.fn(),
  revokeControlPanelCloudflareInstallation: vi.fn(),
}));

const { EnvironmentSettings } = await import("#components/environments/environment-settings");
