...
import { flagImplementationConfigurationFromView } from "#lib/connect/flag-implementation-configuration";
import { Alert, AlertDescription, AlertTitle } from "@splitch/ui/components/alert";
import { renderFlagImplementationPrompt } from "#lib/connect/implementation-prompt";
import { useFlagEditing } from "#lib/flags/use-flag-editing";
import { CodeAgentPrompt } from "#components/connect/code-agent-prompt";
import { FlagDetailDefinition } from "#components/flags/flag-detail-definition";
import { FlagDetailEnvConfig } from "#components/flags/flag-detail-env-config";
import { FlagDetailExperimentBanner } from "#components/flags/flag-detail-experiment-banner";
import { GatedWriteOutcome } from "#components/approval/gated-write-outcome";
