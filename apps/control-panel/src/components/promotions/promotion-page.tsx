...
import { type PromotionRow, promotionDiff } from "#lib/promotions/promotion-diff";
import {
  availabilityOnlySelection,
  variantSelection,
  wholeConfigSelection,
} from "#lib/promotions/promotion-selection";
import { type FlagPromotionScope, useFlagPromotion } from "#lib/flags/use-flag-promotion";
import { GatedWriteOutcome } from "#components/approval/gated-write-outcome";
import { PromotionDependencyNudge } from "#components/promotions/promotion-dependency-nudge";
import { PromotionDiffTable } from "#components/promotions/promotion-diff-table";
import { PromotionSourcePicker } from "#components/promotions/promotion-source-picker";
