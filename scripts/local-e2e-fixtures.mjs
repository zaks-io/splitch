...
INSERT INTO flags (id, app_id, key, name, schema, default_variant_id, created_at, updated_at, created_by, updated_by) VALUES
  ...
  ('flag_checkout_conclusion_e2e', 'app_checkout_e2e', 'checkout-conclusion', 'Checkout Conclusion', '{"type":"boolean"}', 'variant_conclusion_control_e2e', '${createdAt}', '${createdAt}', 'user_local_e2e', 'user_local_e2e'),
...
INSERT INTO variants (id, flag_id, name, value, created_at) VALUES
  ...
  ('variant_conclusion_control_e2e', 'flag_checkout_conclusion_e2e', 'control', 'false', '${createdAt}'),
  ('variant_significance_treatment_e2e', 'flag_checkout_significance_e2e', 'treatment', 'true', '${createdAt}'),
  ('variant_conclusion_treatment_e2e', 'flag_checkout_conclusion_e2e', 'treatment', 'true', '${createdAt}'),
...
INSERT INTO flag_configs (id, app_id, environment_id, flag_id, enabled, available_variant_names, default_variant_id, created_at, updated_at) VALUES
  ...
  ('config_conclusion_dev_e2e', 'app_checkout_e2e', 'env_checkout_dev_e2e', 'flag_checkout_conclusion_e2e', 1, '["control","treatment"]', 'variant_conclusion_control_e2e', '${createdAt}', '${createdAt}'),
...
INSERT INTO experiments (id, app_id, environment_id, key, flag_id, name, status, targeting_key_field, targeting_key_type, default_variant_id, metrics, guardrail_metrics, dimensions, live_run_id, created_at, updated_at, created_by, updated_by) VALUES
  ...
  ('experiment_checkout_conclusion_e2e', 'app_checkout_e2e', 'env_checkout_dev_e2e', 'checkout-conclusion', 'flag_checkout_conclusion_e2e', 'Checkout Conclusion', 'running', 'targetingKey', 'user', 'variant_conclusion_control_e2e', '[{"metricId":"checkout-conversion"}]', '[]', '[]', 'run_checkout_conclusion_e2e', '${createdAt}', '${createdAt}', 'user_local_e2e', 'user_local_e2e'),
...
INSERT INTO runs (id, app_id, environment_id, experiment_id, run_number, status, targeting_key_field, targeting_key_type, salt, allocation, variant_set, control_variant_id, targeting_rules, activation_metric_id, confidence_level, decision_family, guardrail_decisions, config_hash, started_at, created_at, created_by) VALUES
  ...
  ('run_checkout_conclusion_e2e', 'app_checkout_e2e', 'env_checkout_dev_e2e', 'experiment_checkout_conclusion_e2e', 1, 'running', 'targetingKey', 'user', '${run.salt.conclusion}', '${json(run.allocation.checkout)}', '${json(run.variants.conclusion)}', 'variant_conclusion_control_e2e', '${json(run.targetingRules)}', NULL, 0.95, '${d1RunDecisions("checkout-conversion")}', '[]', '${run.hash.conclusion}', '${createdAt}', '${createdAt}', 'user_local_e2e'),
